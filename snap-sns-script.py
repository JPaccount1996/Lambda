...
def lambda_handler(event, context):
    try:
        ...
        TRY THIS IF YOU NOT GET OUTPUT FOR ABOVE SCRIPT
...
# Environment variables for SNS Topic ARN and volume ID
SNS_TOPIC_ARN = "arn:aws:sns:us-east-1:851725476673:darshan"  # e.g., arn:aws:sns:us-east-1:123456789012:MyTopic
VOLUME_ID = "vol-0cb2cac36b7be3f1a"         # e.g., vol-1234abcd
